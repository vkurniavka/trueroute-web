...
<ScreenshotPlaceholder label="map view in GPS Mode showing blue position marker" />
...
<ScreenshotPlaceholder label="map view in Enhanced Mode showing position marker with accuracy ring" />
...
<ScreenshotPlaceholder label="map view in Dead Reckoning Mode showing orange position marker" />
...
<ScreenshotPlaceholder label="GPS disruption warning banner at confidence score 0.6" />
